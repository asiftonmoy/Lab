...
<body>
	...
	<div class="panel panel-primary" style="margin: 0 10% auto;">
	    <div class="panel-heading" style="text-align: center;">
	    	<h4>Edit Digital Electronics Lab Equipment Details</h4>
	    </div>
	    <div class="panel-body">
<?php
	$rnooo=trim($_GET["rno"]);
	$rs1=mysql_query("SELECT * from lab2 where lab2no='".$rnooo."'");
	$sno=1;
	while ($row=mysql_fetch_array($rs1)) {
?>

      		<form action="lab2update.php" name="fpmod" method="post">
