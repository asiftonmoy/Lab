...
<html>
	...
	<body>
		...
		<div class="container" style="margin-bottom: 5%;">
			<h2 style="text-align: center;"><u>Digital Electronics Lab: Save Records</u></h2>
		</div>
		...
		<?php
			...
			if ($error==0) { 
				mysql_query("insert into lab2(lab2name, lab2addr, lab2IssueEquip, lab2EquipDetails, lab2show) values('".$name."','".$addr."','".$IssueEquipment."','".$EquipmentDetails."','Y')");
		...
		<div class="container" style="width: 60%; margin:0 auto;">
			...
			<form action="lab2save.php" name="fdadd" method="post">
