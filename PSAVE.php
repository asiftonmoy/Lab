...
<html>
	...
	<body>
		...
		<div class="container" style="margin-bottom: 5%;">
			<h2 style="text-align: center;"><u>Save Records</u></h2>
		</div>
		...
		<?php
			...
			if ($error==0) { 
				mysql_query("insert into LAB(pname,paddr,pIssueEquipment,pEquipmentDetails,pshow) values('".$name."','".$addr."','".$IssueEquipment."','".$EquipmentDetails."','Y')");
		...
		<div class="container" style="width: 60%; margin:0 auto;">
			...
			<form action="psave.php" name="fdadd" method="post">
