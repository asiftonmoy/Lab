...
<html>
	...
	<body>
		...
		<div class="container" style="margin-bottom: 5%;">
			<h2 style="text-align: center;"><u>Update Records</u></h2>
		</div>
		...
		<?php
			...
			if ($error == 0) { 
				mysql_query("update LAB set pname='".$name."',pIssueEquipment='".$IssueEquipment."',pEquipmentDetails='".$EquipmentDetails."',paddr='".$addr."' where pno='".$rno."'");
		...
		<div class="container" style="width: 60%; margin:0 auto;">
			...
			<form action="pupdate.php" name="fdadd" method="post">
