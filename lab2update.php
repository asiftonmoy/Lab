...
<html>
	...
	<body>
		...
		<div class="container" style="margin-bottom: 5%;">
			<h2 style="text-align: center;"><u>Digital Electronics Lab: Update Records</u></h2>
		</div>
		...
		<?php
			...
			if ($error == 0) { 
				mysql_query("update lab2 set lab2name='".$name."',lab2IssueEquip='".$IssueEquipment."',lab2EquipDetails='".$EquipmentDetails."',lab2addr='".$addr."' where lab2no='".$rno."'");
		...
		<div class="container" style="width: 60%; margin:0 auto;">
			...
			<form action="lab2update.php" name="fdadd" method="post">
		...
		<div class="well well-sm" style="margin-top: 5%;">
			<h4 style="text-align: center;"><a href=lab2.php>Continue...</a></h4>
		</div>
	</body>
</html>
