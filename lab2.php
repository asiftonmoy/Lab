...
<html>
 	...
 	<body>
		...
		<!-- <form action="lab2search.php" method="post" style="text-align: right;">
             Search: <input type="text" name="search" placeholder=" Search here ... "/>
        <input type="submit" value="Submit" />
</form> -->
 		<br>

		<form action="lab2search.php" method="post" style="text-align: center;">
		...
		<div class="container">
			<h3><a href="addlab2.php">Add New Record</a></h3>
		</div>
		  		...
		  		<table class="table table-striped table-condensed">
				    ...
				    <tbody>	
						<?php
							...
							href=lab2undel.php?rno=".$row[0].">Recover</a></td></tr>";
							 $sno++;
							}
							if ($sno==1) echo "<tr><td align=center><font size=4 color=red>Records
							Not Found</font></td></tr>";
